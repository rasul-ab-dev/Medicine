    ...
    <div class="component-wrapper">
      ...
      >
        ...
        <template #blood-glucose>
          <span>MAgnit-rezonans tomografiýa barlagynyň beýany</span>
        </template>
...
import { Tomography } from "~/infrastructure/classes/administration/Tomography";
...
export default Vue.extend({
  ...
  data() {
    let tomography: ITomography = new Tomography(
  ...
  mounted() {
    this.tomography.cabinet = this.currentBlank.cabinetId;
    this.tomography.doctor = this.currentBlank.userId;
    this.tomography.date = this.currentBlank.observationDate;
    this.tomography.patient = this.currentBlank.applicantId;
  },
  computed: {
    cabinetOptions() {
    ...
    permissionControler() {
      ...
      let permission =
        parseGetToken?.UserId == this.tomography.doctor ||
