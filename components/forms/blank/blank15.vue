      ...
      >
        <DxGroupItem :col-count="2">
          <DxGroupItem :col-count="4">
            ...
            <DxSimpleItem
              :col-span="2"
              data-field="examinationDescription"
        ...
        >
          <DxLabel text="Barlaglaryň netijesi" />
        </DxSimpleItem>
        ...
        <DxSimpleItem
          data-field="definitionOfDisease"
          editor-type="dxTextArea"
          :editor-options="{ height: 120 }"
        >
        ...
        <template #blood-glucose>
          <span>Lukmanyň barlagynyň beýany</span>
        </template>
...
import { CommonBlank } from "~/infrastructure/classes/administration/CommonBlank";
...
export default Vue.extend({
  ...
  data() {
    let commonBlank: ICommonBlank = new CommonBlank(
  ...
  mounted() {
    this.commonBlank.cabinet = this.currentBlank.cabinetId;
    this.commonBlank.doctor = this.currentBlank.userId;
    this.commonBlank.date = this.currentBlank.observationDate;
    this.commonBlank.patient = this.currentBlank.applicantId;
  },
  computed: {
    cabinetOptions() {
    ...
    permissionControler() {
      ...
      let permission =
        parseGetToken?.UserId == this.commonBlank.doctor ||
