  ...
  <div>
    ...
    <div class="component-wrapper">
      ...
      >
        ...
        <DxSimpleItem data-field="checkingMember" editor-type="dxTextArea">
          <DxLabel location="left" text="Barlanýan agza" />
        </DxSimpleItem>
        ...
        >
          <DxLabel location="left" text="Maslahat" />
        </DxSimpleItem>
        ...
        <template #blood-glucose>
          <span>Şöhle bilen anyklaýyş barlagynyň beýany</span>
        </template>
        <DocumentEditorPopup
...
import { Rentgen } from "~/infrastructure/classes/administration/Rentgen";
...
export default Vue.extend({
  ...
  data() {
    let rentgen: IRentgen = new Rentgen(
  ...
  mounted() {
    this.rentgen.cabinet = this.currentBlank.cabinetId;
    this.rentgen.doctor = this.currentBlank.userId;
    this.rentgen.date = this.currentBlank.observationDate;
    this.rentgen.patient = this.currentBlank.applicantId;
  },
  computed: {
    cabinetOptions() {
    ...
    permissionControler() {
      ...
      let permission =
        parseGetToken?.UserId == this.rentgen.doctor ||
