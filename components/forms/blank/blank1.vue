...
export default Vue.extend({
  ...
  mounted() {
    this.legsVeinBlank.cabinet = this.currentBlank.cabinetId;
    this.legsVeinBlank.doctor = this.currentBlank.userId;
    this.legsVeinBlank.date = this.currentBlank.observationDate;
    this.legsVeinBlank.patient = this.currentBlank.applicantId;
  },
  computed: {
    cabinetOptions() {
    ...
    permissionControler() {
      ...
      let permission =
        parseGetToken?.UserId == this.legsVeinBlank.doctor ||
