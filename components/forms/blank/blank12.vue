    ...
    <div class="component-wrapper">
      ...
      >
        ...
        <DxGroupItem :col-count="2">
          ...
          <DxSimpleItem data-field="weight">
            <DxLabel text="Agramy" />
          </DxSimpleItem>
        </DxGroupItem>
...
import { Ecg } from "~/infrastructure/classes/administration/Ecg";
...
export default Vue.extend({
  ...
  data() {
    let ecg: IEcg = new Ecg(JSON.parse(this.currentBlank.observationResult));
  ...
  mounted() {
    this.ecg.cabinet = this.currentBlank.cabinetId;
    this.ecg.doctor = this.currentBlank.userId;
    this.ecg.date = this.currentBlank.observationDate;
    this.ecg.patient = this.currentBlank.applicantId;
  },
  computed: {
    cabinetOptions() {
    ...
    permissionControler() {
      ...
      let permission =
        parseGetToken?.UserId == this.ecg.doctor ||
